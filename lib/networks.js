 ...
 * @return Network
 */
function get(arg, keys, multiple = false) {
...
addNetwork({
  ...
  fee: [500, 1000, 1500] // slow, medium, fast
});
/**
 * @instance
...
addNetwork({
  ...
  alias: 'dgbt',
  pubkeyhash: 126,         // PUBKEY_ADDRESS
  scripthash: 140,         // SCRIPT_ADDRESS
  privatekey: 254,         // SECRET_KEY
  ...
  explorers: [
    "https://testnetexplorer.digibyteservers.io/api/v2/"
  ],
 ...
 * @member Networks#digibyte
 */
var digibytetest = get('digibyte-testnet');
...
addNetwork({
  ...
  fee: [900, 1000, 1100] // slow, medium, fast
});
/**
 * @instance
